/*
 ...
 Source Schema         : AimaijiIOSDataBase
...
-- ----------------------------
BEGIN;
INSERT INTO `typeinfo` VALUES ('vivo', 'photo1.jpg', NULL);
INSERT INTO `typeinfo` VALUES ('三星', 'Samsung.jpg', NULL);
INSERT INTO `typeinfo` VALUES ('其他品牌', 'photo1.jpg', NULL);
INSERT INTO `typeinfo` VALUES ('华为', 'HUAWEI.jpg', NULL);
INSERT INTO `typeinfo` VALUES ('小米', 'MI.jpg', NULL);
INSERT INTO `typeinfo` VALUES ('苹果', 'Apple.jpg', NULL);
COMMIT;
...
CREATE TABLE `usercart` (
  ...
  `itemimageurl` varchar(255) NOT NULL,
  `itemprice` int(11) NOT NULL,
  `itemowner` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`itemname`,`itemowner`(255)) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `usercart` VALUES ('iPhone 8', 'iphone8', 9999, 'lixingyu');
INSERT INTO `usercart` VALUES ('iPhone 8 Plus', 'iphone8plus.jpg', 7220, 'lixingyu');
...
-- ----------------------------
BEGIN;
INSERT INTO `userinfo` VALUES ('aimaijiFirstuser', '8645', 'default.png', '这是aimaiji网站的第一个用户，他似乎很喜欢网站作者给他的头像，这个头像后来被用作未修改头像用户的默认头像......');
INSERT INTO `userinfo` VALUES ('aimaijiSecondUser', '8645', 'default.png', '该用户还没有个人介绍......');
INSERT INTO `userinfo` VALUES ('aimaijiThirdUser', '8645', 'default.png', '该用户还没有个人介绍......');
INSERT INTO `userinfo` VALUES ('Assad', '11111', 'default.png', '该用户还没有个人介绍......');
INSERT INTO `userinfo` VALUES ('lixingyu', '8645', 'default.png', '该用户还没有个人介绍......');
INSERT INTO `userinfo` VALUES ('mofashaonvXX', '86456343', 'photo1.jpg', '我从美德中汲取力量，保护我的同伴，痛击我的敌人。\r\n\r\n正义的火焰，将焚烧一切敌手！\r\n\r\n勇气的圣盾，能抵御一切进攻！\r\n\r\n决心的守护，将使我精神百倍，安然归来！\r\n\r\n战场上，我能够使用单手剑、巨锤、巨剑、钉锤、节仗、法杖、聚能器、火炬、盾牌；\r\n\r\n深海下，我能够使用长矛和三叉戟。\r\n\r\n除此之外，强大的灵魂武器更是一切对手的梦魇，\r\n\r\n然而这些 ，都不是作为一名守护者的重要的因素，\r\n\r\n守护者真正的力量，来自强大的内心以及无私的牺牲。\r\n\r\n每一名真正的守护者，都是杰出的战术大师和无私的防御者，\r\n\r\n每一名真正的守护者，都知晓什么时候牺牲自己的防御，帮助盟友取得胜利。\r\n\r\n我是F91，这是我的激战2故事，我在激战2等你！');
INSERT INTO `userinfo` VALUES ('qqqqq', '11111', 'default.png', '该用户还没有个人介绍......');
INSERT INTO `userinfo` VALUES ('sunyifeng', '25zai', 'default.png', '我从美德中汲取力量，保护我的同伴，痛击我的敌人。\r\n\r\n正义的火焰，将焚烧一切敌手！\r\n\r\n勇气的圣盾，能抵御一切进攻！\r\n\r\n决心的守护，将使我精神百倍，安然归来！\r\n\r\n战场上，我能够使用单手剑、巨锤、巨剑、钉锤、节仗、法杖、聚能器、火炬、盾牌；\r\n\r\n深海下，我能够使用长矛和三叉戟。\r\n\r\n除此之外，强大的灵魂武器更是一切对手的梦魇，\r\n\r\n然而这些 ，都不是作为一名守护者的重要的因素，\r\n\r\n守护者真正的力量，来自强大的内心以及无私的牺牲。\r\n\r\n每一名真正的守护者，都是杰出的战术大师和无私的防御者，\r\n\r\n每一名真正的守护者，都知晓什么时候牺牲自己的防御，帮助盟友取得胜利。\r\n\r\n我是F91，这是我的激战2故事，我在激战2等你！');
INSERT INTO `userinfo` VALUES ('testuser', '123456', 'default.png', '该用户还没有个人介绍.....');
INSERT INTO `userinfo` VALUES ('user1111', '1234567', 'default.png', '该用户还没有个人介绍......');
INSERT INTO `userinfo` VALUES ('呵呵呵', '22', 'default.png', '该用户还没有个人介绍.....');
COMMIT;
